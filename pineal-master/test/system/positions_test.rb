...
class PositionsTest < ApplicationSystemTestCase
  ...
  test "creating a Position" do
    ...
    fill_in "Contrato", with: @position.contrato
    fill_in "Fip", with: @position.fip
    fill_in "Nombre", with: @position.nombre
    fill_in "Rol", with: @position.rol
    fill_in "Superintendence", with: @position.superintendence_id
    fill_in "Vacantes", with: @position.vacantes
