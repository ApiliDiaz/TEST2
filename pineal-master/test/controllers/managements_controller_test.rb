...
class ManagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create management" do
    assert_difference('Management.count') do
      post managements_url, params: { management: { sigla: @management.sigla, vicepresidency_id: @management.vicepresidency_id } }
    end
  ...
  test "should update management" do
    patch management_url(@management), params: { management: { sigla: @management.sigla, vicepresidency_id: @management.vicepresidency_id } }
